package com.bmbstack.kit.widget.gradientui;
...
public class GradientTextView extends FrameLayout {
    ...
    private void initView(Context context) {
        ...
        mTopTextView = findViewById(R.id.top_textview);
    ...
    public void setGradientTypeface(int style) {
        mTopTextView.setTypeface(Typeface.defaultFromStyle(style));
        mBottomTextView.setTypeface(Typeface.defaultFromStyle(style));
    }
